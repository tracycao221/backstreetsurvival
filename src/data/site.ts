...
export const siteConfig: SiteConfig = {
  ...
  description: `${gameConfig.name} wiki with code status, tier list notes, Trello and Discord status, calculators, guides, and source-backed Roblox progression help.`,
  valueProposition: `Check ${gameConfig.name} code status, compare early survival priorities, and use practical tools before you spend time grinding in Roblox.`,
...
export const heroMetrics: HeroMetric[] = [
  { label: "Code status", value: "No verified", note: "Designed for frequent checks" },
